...
public class QADocReqInit extends UnifiedAgent {
    ...
    protected Object execute() {
        ...
        try {
            ...
            if(!dsts.equals("PUBLISH") && !dsts.equals("ARCHIVED") && !dsts.equals("REVISED") && !dsts.equals("WA4APRV")) {
                document.setDescriptorValue(Conf.Descriptors.Status, "WA4APRV");
                document.setDescriptorValue(Conf.Descriptors.RevNr, "");
                document.commit();
            }

            Utils.disconnectToFolder((IFolder) qaInfObj, "Dokümanlar", "İçe Aktarılanlar", document);
            Utils.disconnectToFolder((IFolder) qaInfObj, "Dokümanlar", "Taslaklar", document);
